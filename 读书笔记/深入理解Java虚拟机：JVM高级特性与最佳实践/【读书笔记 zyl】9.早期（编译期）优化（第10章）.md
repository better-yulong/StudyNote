...
```
因IDE该测试工程的jdk版本为jdk7，IDE会直接报错（Erasure of method method1_1(ArrayList<String>) is the same as another method in type GenericTypesTest）；故通过javac命令基于JDK1.7编译，会报错：
```
