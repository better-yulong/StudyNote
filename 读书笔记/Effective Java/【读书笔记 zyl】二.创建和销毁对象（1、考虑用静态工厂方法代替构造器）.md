...
- 提供者注册API：服务提供者接口的具体实现类里面去注册这个API。如java.sql.DriverManager：既然服务服务提供者接口是Driver，那用来注册和管理的类自然就是DriverManager，其中registeredDriver()方法即将当前第三方服务的服务提供者的实现OracleDriver注册到服务列表registeredDrivers。而第三方服务实现
