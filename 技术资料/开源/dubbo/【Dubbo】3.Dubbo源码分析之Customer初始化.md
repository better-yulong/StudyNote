...
2.当实现化EntryController时，因其@Autowired private DubboExampleInterf1 dubboExampleService1;需注入实例，那么根据之前分析SpringIOC源码，则可知此时会调用ReferenceBean的getObject方法（因为ReferenceConfig实现
