...
#### 4.3 bean实例化分析
根据DubboNamespaceHandler可发现，涉及dubbo的标签会实例化ApplicationConfig、ModuleConfig、RegistryConfig、MonitorConfig、ProviderConfig、ConsumerConfig、ProtocolConfig、ServiceBean、ReferenceBean、AnnotationBean 这10类bean；
