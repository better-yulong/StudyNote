...
#### 4.3 bean实例化分析
根据DubboNamespaceHandler可发现，dubboApplicationConfig、ModuleConfig、RegistryConfig、MonitorConfig、ProviderConfig、ConsumerConfig、ProtocolConfig、ServiceBean、ReferenceBean、AnnotationBean
