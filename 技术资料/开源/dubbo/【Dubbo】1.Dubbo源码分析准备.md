...
根据xml文件头dubbo的xmlns:dubbo="http://code.alibabatech.com/schema/dubbo",可根据code.alibabatech.com/schema/dubbo搜索，即可在 工程META-INF\spring.schemas找到对应配置：
> http\://code.alibabatech.com/schema/dubbo/dubbo.xsd=META-INF/dubbo.xsd；
同时亦可在META-INF\spring.schemas找到
