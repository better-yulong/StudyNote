...
#### 4.3 bean实例化分析
根据DubboNamespaceHandler可发现，涉及dubbo的标签会实例化ApplicationConfig、ModuleConfig、RegistryConfig、MonitorConfig、ProviderConfig、ConsumerConfig、ProtocolConfig、ServiceBean、ReferenceBean、AnnotationBean 这10类bean；而前面7种相对简单，即可认为是简单数据对象；而ServiceBean、ReferenceBean、AnnotationBean则除数据外还
