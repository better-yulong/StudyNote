...
2.AutowiredAnnotationBeanPostProcessor-->postProcessMergedBeanDefinition-->findAutowiringMetadata会查找使用@Component（及）的Field、Methods并封装ResourceElement使用当前所属class存储至CommonAnnotationBeanPostProcessor的injectionMetadataCache以便后续使用；
