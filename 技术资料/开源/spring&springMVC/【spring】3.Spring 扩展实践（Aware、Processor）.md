...
```language
	...
	protected void registerBeanPostProcessors(ConfigurableListableBeanFactory beanFactory) {
                //即可获取internalAutowiredAnnotationProcessor、internalRequiredAnnotationProcessor、internalCommonAnnotationProcessor；该方法会遍历所有的beanDefinitionNames及BeanDefinition与BeanPostProcessor
