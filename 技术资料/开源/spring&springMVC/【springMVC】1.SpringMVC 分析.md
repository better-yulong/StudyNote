...
- BeanNameUrlHandlerMapping、DefaultAnnotationHandlerMapping拥有共同直接父类AbstractDetectingUrlHandlerMapping、间接共同接口ApplicationContextAware，那么根据分析BeanNameUrlHandlerMapping原始对象创建之后即
