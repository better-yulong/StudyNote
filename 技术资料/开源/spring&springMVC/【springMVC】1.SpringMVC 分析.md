...
上面已经分析了基于注解方式的时，DefaultAnnotationHandlerMapping会依次解析class、method方法上的@RequestMapping注解，生成url并将url与ExampleControler.class映射保存至其handlerMap；而BeanNameUrlHandlerMapping呢？如其如应该就是beanName名称url处理，直接找改
