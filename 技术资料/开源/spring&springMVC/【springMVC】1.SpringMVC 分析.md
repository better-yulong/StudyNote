...
```
###### 补充知识点
当spring的xml配置文件中，手动注入bean（xml的bean标签： name="/exampleController"）与context:component-scan(且class需有@Controller(value="/exampleController2")同时配置时会xml的顺序优先取前面对应的name值
