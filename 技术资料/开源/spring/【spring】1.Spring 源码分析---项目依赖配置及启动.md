...
上面可看出parseDefaultElement用于解析默认beans节点默认只支持import、alias、bean、beans四类子节点，因重点分析bean标签解析故上面只贴了processBeanDefinition方法源码；另外parseDefaultElementspring4个标签示例如： 
 ```language
