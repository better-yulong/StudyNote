...
- sc.getInitParameter(CONFIG_LOCATION_PARAM)其中CONFIG_LOCATION_PARAM参数为常量值：contextConfigLocation，即获取web.xml中的初始化参数contextConfigLocation的值（如若未设置返回""），该配置可支持多种配置方式如：
```language
    <context-param>
