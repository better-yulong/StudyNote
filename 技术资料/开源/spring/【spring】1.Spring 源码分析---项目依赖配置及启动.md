...
```
 - 上面可看出beans节点默认只支持import、alias、bean、beans四类子节点， 其中代码：BeanDefinitionHolder bdHolder = delegate.parseBeanDefinitionElement(ele)对应BeanDefinitionParserDelegate类
```language
