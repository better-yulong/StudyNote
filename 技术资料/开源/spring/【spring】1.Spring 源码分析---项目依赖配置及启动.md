...
上面可看出parseDefaultElement用于解析默认元素；beans节点默认只支持import、alias、bean、beans四类子节点，因重点分析bean标签解析故上面只贴了processBeanDefinition方法源码；而parseCustomElement则用于支持解析spring4个标签示例如： 
 ```language
