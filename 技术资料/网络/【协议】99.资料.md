...
HTTP长连接--Keep-Alive  https://www.cnblogs.com/thomson-fred/p/10197456.html   Http实现长连接需要客户端和服务端都支持长连接。在TCP连接的两端，谁主动断开连接(先发送FIN包)，谁进入TIME WAIT，谁被动断开连接(后发送FIN包)，谁进入CLOSE WAIT状态。比如Http请求头